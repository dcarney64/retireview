// Broker Settings — live brokerage connections (SnapTrade OAuth + Composer Direct API).
// Manual accounts (TSP, real estate, cash …) are managed on the Accounts page.
            ...
            >
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  />
                  <button type="button" className="absolute right-2 top-1/2 -translate-y-1/2 text-xs text-slate-400 hover:text-slate-200"
        ...
        >
          ...
          <div className="flex gap-2">
            <Button
              ...
              onClick={() => { setStatusMsg(null); testMutation.mutate({ keyId: form.keyId, keySecret: form.keySecret }); }}
            >
...
export default function BrokerSettings() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-2xl font-semibold text-slate-100">Broker Connections</h2>
        <p className="text-sm text-slate-400">
          Connect your brokerages to sync balances automatically.
        </p>
      </div>
      ...
      {/* Section 3: Manual accounts note */}
      <div className="rounded-lg border border-slate-700/40 bg-slate-800/50 px-4 py-3 text-sm text-slate-400">
        <span className="font-medium text-slate-300">Manual accounts</span> (TSP, real estate,
        cash) are managed directly on the{' '}
        <button
          type="button"
